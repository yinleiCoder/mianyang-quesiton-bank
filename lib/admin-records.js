...
export const AUDIT_ACTION_LABELS = {
  ...
  // 班级与学生学籍（0063）。这是审计页文案的**唯一来源**，漏一个就会在页面上显示成裸 key。
  admin_create_class: "新建班级",
  admin_update_class: "修改班级",
  admin_set_class_active: "启用/停用班级",
  admin_bulk_assign_class: "批量分配班级",
  admin_update_student: "修改学生学籍",
  admin_set_teacher_major: "设置任教专业",
  // 未登录自助重置密码（0072/0073）：没有登录者，detail 里带 user_id/identifier/姓名/身份
  self_reset_password: "自助重置密码",
}
