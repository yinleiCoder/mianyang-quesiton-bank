...
export const FLAG_LABELS = {
  cross_page: {
    text: "跨页截断",
    hint: "这道题在本页末尾被截断。下一页会给出拼好的完整题——请用那一条，这一条不要勾选；若下一页没能解析出来，再回来在这里补全。",
  },
  merged_cross_page: {
    text: "已合并跨页",
    hint: "本页开头接着上一页那道题，两部分已自动拼成完整题干——请核对拼接处是否通顺、有没有缺话。",
  },
  ...
  ai_answer: { text: "AI 推导答案", hint: "原卷没有答案，这是模型自己解出来的——请照着解析核对一遍" },
}
...
const JOB_COLUMNS =
  ...
  // 整卷还原（0050）：mode 决定提示词与预览列，paper_meta 是抽到的卷头，paper_id 是成卷后的回填
  "mode, paper_meta, paper_id"
...
const ITEM_COLUMNS =
  ...
  // 整卷还原（0050）：分节归属与每题分值，预览页要显示、一键成卷要用
