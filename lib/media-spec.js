...
// 复习资料支持的类型：**刻意与题目媒体取同一份**——教师能放进题目的格式，也就能放进资料区
// （PDF / Office 四件套 / 图片 / 音视频 / 文本）。将来若要分道扬镳（比如资料区不收 gif），
// 在这里 spread 出一份新的即可，别去改那份，否则会连带改掉题目媒体的白名单。
const MATERIAL_TYPES = QUESTION_MEDIA_TYPES
