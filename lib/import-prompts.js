...
题目对象字段：
{
  ...
  "flags": ["has_figure" | "has_formula" | "ai_analysis" | "ai_answer" | "cross_page" | "low_confidence"],
 ...
 */
export function buildPageParts({ pageNo, text, prevTail, images = [], note, paperMode = false }) {
  const parts = []
